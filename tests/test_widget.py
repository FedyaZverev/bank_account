...
def test_mask_account_card(test_mask_number: str) -> None:
...
def test_mask_account_number(test_mask_account: str) -> None:
...
@pytest.mark.parametrize(
    "number, expected",
    [
        ("Mae st ro12 3 4 12 3412 34 1 234", "Maestro 1234 12** **** 1234"),
...
def test_mark_number(number: str, expected: str) -> None:
...
def test_date(test_get_date: str) -> None:
...
def test_get_data_mark(data_str: str, expected: str) -> None:
