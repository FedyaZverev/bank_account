...
class TestGetTransactionAmount(unittest.TestCase):
    ...
    def transaction_amount(self, transaction: dict) -> float | list:
    ...
    def test_get_transaction_amount_rub(self):
        ...
        self.assertEqual(self.transaction_amount(transaction), 100.00)
    ...
    def test_get_transaction_amount_usd_success(self, mock_request):
        ...
        actual_amount = self.transaction_amount(transaction)
    ...
    def test_get_transaction_amount_usd_api_error(self, mock_request):
        ...
        self.assertEqual(self.transaction_amount(transaction), [])
